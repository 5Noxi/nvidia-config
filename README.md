...
`3D Settings > Configure Surround, PhysX` - Select your GPU
...
`Display > Adjust desktop color settings` - Increase `Digital vibrance` up to a level you prefer
> https://discord.com/channels/836870260715028511/1402204193300942888/1411332090506645586
```ps
...
`Video > Adjust video color settings` (preference)
```ps
